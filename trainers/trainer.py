...
def train_parser():
    ...
    parser.add_argument("--epoch_size", help="number of episode in each epoch", type=int, default=100)
    parser.add_argument("--gamma_loss", help="number of episode in each epoch", type=float)
    ...
    parser.add_argument("--num_class", help="calculate Lanchor",type=int,default=100)
    parser.add_argument("--noise", action="store_true")
    parser.add_argument("--noise_value", type=float, default=0.2)
    parser.add_argument("--model", type=str, default='FRN')
    parser.add_argument("--cL_scale", type=float, default=0.1)
